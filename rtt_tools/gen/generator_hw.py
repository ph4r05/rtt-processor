...
class GeneratorCfgHW:
    cs_input_strategy_prefix = 'hw'
    plaintext_target_stream = CfgDefaults.hw_stream
    ...
    hash_funs = {
        ...
        'MD5': FunArgs(16, None, None, (11, 12, 13, 14, 15, 16, 17, 18, 19)),
        'MD6': FunArgs(32, None, None, (5, 6, 7, 8, 9, 10)),
        'RIPEMD160': FunArgs(20, None, None, (11, 12, 13, 14, 15)),
        'SHA1': FunArgs(20, None, None, (14, 15, 16, 17)),
        'SHA2': FunArgs(32, None, None, (11, 12, 13, 14, 15)),
    ...
    block_funs = {
        ...
        'GOST': FunArgs(8, 32, None, (7, 8, 9, 10)),
        ...
        'RC5-20': FunArgs(8, 16, None, (2, 3, 4, 5, 6)),
    ...
    block_default = {
        ...
        'round': None,
        'block_size': 16,
        'plaintext': CfgDefaults.hw_stream,
        'key_size': 16,
        'key': CfgDefaults.random_stream,
        'iv_size': 16,
        'iv': CfgDefaults.false_stream
    ...
    def prepare_cfg(self, project, fun, rounds, tv_size, tv_num, seed, name_prefix):
        ...
        with open(cfg_name, 'w') as f:
            ...
            if project == "stream_cipher":
                ...
                stream.update(CfgDefaults.hash_hack(self.hash_funs[fun].block_size, self.plaintext_target_stream))
                current_cfg['stream'] = stream
                ...
                tmp = deepcopy(CfgDefaults.hw_stream)
                if self.block_funs[fun].block_size in [7, 8]:
                    tmp['hw'] = 6
