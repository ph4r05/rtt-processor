...
class GeneratorCfgCtr:
    ...
    block_funs = {
        ...
        'FANTOMAS': FunArgs(16, 16, None, (1, 2, 3, 4, 5)),
        'GOST': FunArgs(8, 32, None, (6, 7, 8, 9)),
        'HIGHT': FunArgs(8, 16, None, (8, 9, 10, 11)),
        ...
        'LEA': FunArgs(16, 16, None, (6, 7, 8, 9, 10)),
        'LED': FunArgs(8, 10, None, (1, 2, 3, 4, 5)),
        'MARS': FunArgs(16, 16, None, (0, 1)),
        'MISTY1': FunArgs(8, 16, None, (1, 2, 3)),
        'NOEKEON': FunArgs(16, 16, None, (1, 2, 3, 4)),
        'PICCOLO': FunArgs(8, 10, None, (2, 3, 4, 5, 6)),
        'PRIDE': FunArgs(8, 16, None, (4, 5, 6, 7, 8)),
        'PRINCE': FunArgs(8, 16, None, (2, 3, 4, 5, 6)),
        ...
        'TWINE': FunArgs(8, 10, None, (6, 7, 8, 9, 10)),
