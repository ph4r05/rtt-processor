...
with open('__enqueue.sh', 'w+') as fh:
    ...
    for name in name_list:
        fh.write("submit_experiment --all_batteries --name 'PH-SMREF-01-%s' --cfg '/home/debian/rtt-home/RTTWebInterface/media/predefined_configurations/100MB.json' --cryptostreams-config '%s'\n" % (name, name))
